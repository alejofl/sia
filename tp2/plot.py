...
if __name__ == "__main__":
    ...
    #comparison([['results/ej1.2/4.pick/traditional-results.csv', 'Traditional'],['results/ej1.2/4.pick/young_biased-results.csv', 'Young Bias']], 'fitness', "Pick type: fitness", "Pick type", fitnessLabel)
    #comparison([['results/ej1.2/4.pick/traditional-results.csv', 'Traditional'],['results/ej1.2/4.pick/young_biased-results.csv', 'Young Bias']], 'executionTime', "Pick type: Execution time", "Pick type", executionTimeLabel)

    # comparison([['results/ej1.2/5.population/pop-1000-results.csv', '1000'],['results/ej1.2/5.population/pop-10000-results.csv', '10000']], 'fitness', "Population: fitness", "Population", fitnessLabel)
    # comparison([['results/ej1.2/5.population/pop-1000-results.csv', '1000'],['results/ej1.2/5.population/pop-10000-results.csv', '10000']], 'executionTime', "Population: Execution time", "Population", executionTimeLabel)

    #/Users/matidt/Documents/2_facultad/4. Cuatri actual/SIA/TPs/sia/tp2/results/ej1.2/5.population

    comparison([['results/ej1.2/6.mates/mates-10-results.csv', '10%'],['results/ej1.2/6.mates/mates-30-results.csv', '30%'], ['results/ej1.2/6.mates/mates-50-results.csv', '50%'], ['results/ej1.2/6.mates/mates-70-results.csv', '70%'], ['results/ej1.2/6.mates/mates-100-results.csv', '100%']], 'fitness', "Mates per generation: fitness", "Individuals (%)", fitnessLabel)
    comparison([['results/ej1.2/6.mates/mates-10-results.csv', '10%'],['results/ej1.2/6.mates/mates-30-results.csv', '30%'], ['results/ej1.2/6.mates/mates-50-results.csv', '50%'], ['results/ej1.2/6.mates/mates-70-results.csv', '70%'], ['results/ej1.2/6.mates/mates-100-results.csv', '100%']], 'executionTime', "Mates per generation: Execution time", "Individuals (%)", executionTimeLabel)   